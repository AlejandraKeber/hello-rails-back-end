...
- **[RoR backend with an API endpoint]**
...
```sh
  git https://github.com/AlejandraKeber/hello-rails-back-end.git
...
- [ ] **[Add design and more functionalities]**
...
Feel free to check the [issues page](https://github.com/AlejandraKeber/hello-rails-back-end/issues).
